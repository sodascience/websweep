...
BOT_NAME = "corporate_scraper"
SPIDER_MODULES = ["corporate_scraper.spiders"]
NEWSPIDER_MODULE = "corporate_scraper.spiders"
...
ITEM_PIPELINES = {
    "corporate_scraper.pipelines.ModelPipeline": 300,
}
